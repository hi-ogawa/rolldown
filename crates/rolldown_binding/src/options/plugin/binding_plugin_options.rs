...
pub struct BindingPluginOptions {
  ...
  #[napi(
    ts_type = "(ctx: BindingPluginContext, code: string, chunk: BindingRenderedChunk, opts: BindingNormalizedOptions) => MaybePromise<VoidNullable<BindingHookRenderChunkOutput>>"
  )]
  pub render_chunk: Option<
    MaybeAsyncJsCallback<
      (BindingPluginContext, String, BindingRenderedChunk, BindingNormalizedOptions),
  ...
  pub augment_chunk_hash:
    Option<MaybeAsyncJsCallback<(BindingPluginContext, BindingRenderedChunk), Option<String>>>,
